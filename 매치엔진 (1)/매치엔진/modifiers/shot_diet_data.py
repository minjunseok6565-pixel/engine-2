...
WEIGHTS_GLOBAL_OUTCOME: Dict[str, Dict[str, Dict[str, float]]] = {
    "PnR": {
        ...
        "TO_BAD_PASS": _w(BH_BALL_SECURITY=-0.80, BH_PASS_CREATION=-0.40, D_STEAL_PRESS=0.60, D_HELP_CLOSEOUT=0.40),
        "TO_HANDLE_LOSS": _w(BH_BALL_SECURITY=-0.80, D_POA=0.60),
        "TO_CHARGE": _w(BH_BALL_SECURITY=-0.50, D_POA=0.50, D_HELP_CLOSEOUT=0.30),
    ...
    "Drive": {
        ...
        "SHOT_3_CS": _w(TEAM_SPACING=0.60, TEAM_CATCH3_QUALITY=0.60, D_HELP_CLOSEOUT=-0.80),
    ...
    "DHO": {
        ...
        "TO_BAD_PASS": _w(BH_BALL_SECURITY=-0.70, D_STEAL_PRESS=0.70),
    ...
    "SpotUp": {
        ...
        "PASS_EXTRA": _w(TEAM_EXTRA_PASS=0.50, D_STEAL_PRESS=-0.40),
        "RESET_HUB": _w(TEAM_EXTRA_PASS=0.30, D_HELP_CLOSEOUT=0.40),
        "TO_BAD_PASS": _w(BH_BALL_SECURITY=-0.40, D_STEAL_PRESS=0.50),
    },
    "Kickout": {
        ...
        "TO_BAD_PASS": _w(BH_BALL_SECURITY=-0.60, D_STEAL_PRESS=0.70),
    ...
    "ExtraPass": {
        ...
        "TO_BAD_PASS": _w(BH_BALL_SECURITY=-0.80, TEAM_EXTRA_PASS=-0.40, D_STEAL_PRESS=0.90),
    ...
    "PostUp": {
        ...
        "TO_BAD_PASS": _w(BH_BALL_SECURITY=-0.70, D_STEAL_PRESS=0.60, D_HELP_CLOSEOUT=0.30),
    ...
    "HornsSet": {
        ...
        "PASS_SHORTROLL": _w(SC_SHORTROLL_PLAY=0.70, BH_PASS_CREATION=0.30, D_POA=0.30),
        "SHOT_MID_PU": _w(BH_PULLUP_THREAT=0.70, D_RIM_PROTECT=0.40),
        "SHOT_3_CS": _w(TEAM_SPACING=0.60, TEAM_CATCH3_QUALITY=0.60, D_HELP_CLOSEOUT=-0.70),
        "SHOT_RIM_LAYUP": _w(BH_DRIVE_PRESSURE=0.60, SC_ROLL_FINISH=0.40, D_RIM_PROTECT=-0.80),
        "TO_BAD_PASS": _w(BH_BALL_SECURITY=-0.70, D_STEAL_PRESS=0.70),
        "RESET_HUB": _w(TEAM_EXTRA_PASS=0.40, D_HELP_CLOSEOUT=0.50),
    },
    "TransitionEarly": {
        ...
        "TO_BAD_PASS": _w(BH_BALL_SECURITY=-0.60, D_STEAL_PRESS=0.40),
...
WEIGHTS_TACTIC_OUTCOME_DELTA: Dict[str, Dict[str, Dict[str, Dict[str, float]]]] = {
    ...
    "Drive_Kick": {
        ...
        "ExtraPass": {
            ...
            "TO_BAD_PASS": _w(D_STEAL_PRESS=0.10),
        },
    },
    "Motion_SplitCut": {
        "Cut": {
    ...
    "Post_InsideOut": {
        "PostUp": {
            ...
            "TO_BAD_PASS": _w(D_HELP_CLOSEOUT=0.15),
