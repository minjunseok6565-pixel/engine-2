...
WEIGHTS_GLOBAL_OUTCOME: Dict[str, Dict[str, Dict[str, float]]] = {
    ...
    "PnP": {
        "PASS_KICKOUT": _w(TEAM_SPACING=1.00, BH_PASS_CREATION=0.55, D_HELP_CLOSEOUT=-0.85),
        "PASS_EXTRA": _w(TEAM_EXTRA_PASS=0.55, BH_PASS_CREATION=0.30, D_STEAL_PRESS=-0.45),
        "SHOT_3_CS": _w(SC_POP_THREAT=1.20, TEAM_CATCH3_QUALITY=1.05, SC_SCREEN_QUALITY=0.60, D_HELP_CLOSEOUT=-0.70),
        "SHOT_MID_CS": _w(SC_POP_THREAT=1.00, SC_SCREEN_QUALITY=0.50, D_RIM_PROTECT=0.35, D_POA=0.20),
        "SHOT_3_OD": _w(BH_PULLUP_THREAT=0.75, SC_SCREEN_QUALITY=0.35, D_POA=0.30),
        "SHOT_MID_PU": _w(BH_PULLUP_THREAT=0.55, SC_SCREEN_QUALITY=0.25, D_POA=0.25, D_RIM_PROTECT=0.25),
        "SHOT_RIM_LAYUP": _w(BH_DRIVE_PRESSURE=0.75, TEAM_SPACING=0.20, D_POA=-0.50, D_RIM_PROTECT=-0.85),
        "SHOT_RIM_DUNK": _w(SC_ROLL_FINISH=0.30, BH_DRIVE_PRESSURE=0.35, D_RIM_PROTECT=-0.95),
        "SHOT_RIM_CONTACT": _w(BH_FOUL_PRESSURE=0.55, BH_DRIVE_PRESSURE=0.25, D_RIM_PROTECT=0.40, D_POA=-0.20),
        "SHOT_TOUCH_FLOATER": _w(BH_DRIVE_PRESSURE=0.55, D_RIM_PROTECT=0.60),
        "TO_HANDLE_LOSS": _w(BH_BALL_SECURITY=-0.70, D_POA=0.70, D_STEAL_PRESS=0.25),
        "TO_CHARGE": _w(BH_BALL_SECURITY=-0.55, D_POA=0.45, D_HELP_CLOSEOUT=0.35),
        "FOUL_DRAW_RIM": _w(BH_FOUL_PRESSURE=0.70, D_RIM_PROTECT=0.20),
        "RESET_RESREEN": _w(SC_SCREEN_QUALITY=0.70, BH_PNR=0.30, D_POA=0.20),
        "RESET_HUB": _w(TEAM_EXTRA_PASS=0.35, BH_PASS_CREATION=0.20, D_HELP_CLOSEOUT=0.45),
    },
    "Drive": {
    ...
    "ISO": {
        "SHOT_3_OD": _w(BH_PULLUP_THREAT=1.05, D_POA=0.55, TEAM_SPACING=0.15),
        "SHOT_MID_PU": _w(BH_PULLUP_THREAT=0.75, D_POA=0.40, D_RIM_PROTECT=0.35, TEAM_SPACING=-0.10),
        "SHOT_RIM_LAYUP": _w(BH_DRIVE_PRESSURE=0.95, D_POA=-0.45, D_RIM_PROTECT=-0.90, TEAM_SPACING=0.30),
        "SHOT_RIM_DUNK": _w(BH_DRIVE_PRESSURE=0.55, D_RIM_PROTECT=-1.00),
        "SHOT_RIM_CONTACT": _w(BH_FOUL_PRESSURE=0.95, D_POA=-0.30, D_RIM_PROTECT=0.45),
        "SHOT_TOUCH_FLOATER": _w(BH_DRIVE_PRESSURE=0.45, D_RIM_PROTECT=0.75),
        "PASS_KICKOUT": _w(BH_PASS_CREATION=0.60, D_HELP_CLOSEOUT=-0.75, TEAM_SPACING=1.00),
        "PASS_EXTRA": _w(BH_PASS_CREATION=0.30, D_STEAL_PRESS=-0.40, TEAM_EXTRA_PASS=0.65),
        "FOUL_DRAW_RIM": _w(BH_FOUL_PRESSURE=0.90, D_RIM_PROTECT=0.25),
        "FOUL_DRAW_JUMPER": _w(BH_FOUL_PRESSURE=0.55, BH_PULLUP_THREAT=0.45, D_POA=0.25),
        "TO_HANDLE_LOSS": _w(BH_BALL_SECURITY=-0.90, D_POA=0.95, D_STEAL_PRESS=0.35),
        "TO_CHARGE": _w(BH_BALL_SECURITY=-0.60, D_HELP_CLOSEOUT=0.45, D_POA=0.45),
        "RESET_HUB": _w(BH_PASS_CREATION=0.20, D_HELP_CLOSEOUT=0.35, TEAM_EXTRA_PASS=0.30),
    },
    "DHO": {
...
WEIGHTS_TACTIC_ACTION: Dict[str, Dict[str, Dict[str, float]]] = {
    "Spread_HeavyPnR": {
        ...
        "ISO": _w(BH_PULLUP_THREAT=0.55, BH_DRIVE_PRESSURE=0.35, TEAM_SPACING=0.25, D_POA=-0.60),
        ...
        "PnP": _w(BH_PNR=1.00, SC_POP_THREAT=0.90, TEAM_SPACING=0.55, SC_SCREEN_QUALITY=0.40, D_POA=-0.55),
    },
    "FiveOut": {
        "SpotUp": _w(TEAM_SPACING=0.90, TEAM_CATCH3_QUALITY=0.60, D_HELP_CLOSEOUT=-0.40),
        "ISO": _w(BH_PULLUP_THREAT=0.70, BH_DRIVE_PRESSURE=0.50, TEAM_SPACING=0.50, D_POA=-0.55),
        ...
        "PnP": _w(SC_POP_THREAT=1.05, TEAM_SPACING=0.70, TEAM_CATCH3_QUALITY=0.45, BH_PNR=0.65, D_POA=-0.50),
    },
    "Drive_Kick": {
        "Drive": _w(BH_DRIVE_PRESSURE=1.30, BH_BALL_SECURITY=0.50, TEAM_SPACING=0.30, D_POA=-0.60, D_RIM_PROTECT=-0.40),
        "ISO": _w(BH_DRIVE_PRESSURE=0.60, BH_PASS_CREATION=0.20, TEAM_SPACING=0.20, D_POA=-0.50),
        ...
        "PnP": _w(SC_POP_THREAT=0.45, BH_PNR=0.50, TEAM_SPACING=0.25, D_POA=-0.35),
    },
    "Motion_SplitCut": {
        "Cut": _w(TEAM_CUTTING=1.20, TEAM_SPACING=0.60, TEAM_EXTRA_PASS=0.40, D_HELP_CLOSEOUT=-0.50),
        "ISO": _w(BH_PULLUP_THREAT=0.40, BH_DRIVE_PRESSURE=0.30, TEAM_CUTTING=-0.30, TEAM_EXTRA_PASS=-0.20, D_POA=-0.50),
        ...
        "PnR": _w(BH_PNR=0.20),
        "PnP": _w(SC_POP_THREAT=0.35, BH_PNR=0.35, TEAM_EXTRA_PASS=0.20),
    },
    "DHO_Chicago": {
        "DHO": _w(SC_SCREEN_QUALITY=1.20, TEAM_CATCH3_QUALITY=0.80, BH_PASS_CREATION=0.40, D_HELP_CLOSEOUT=-0.50, D_STEAL_PRESS=-0.40),
        "ISO": _w(BH_PULLUP_THREAT=0.50, BH_DRIVE_PRESSURE=0.30, TEAM_SPACING=0.20, D_POA=-0.50),
        ...
        "PnP": _w(SC_POP_THREAT=0.45, BH_PNR=0.25, TEAM_CATCH3_QUALITY=0.25),
    },
    "Post_InsideOut": {
        "PostUp": _w(TEAM_POST_GRAVITY=1.40, TEAM_SPACING=0.40, D_POST=-0.50, D_HELP_CLOSEOUT=-0.30),
        "ISO": _w(BH_PULLUP_THREAT=0.45, BH_DRIVE_PRESSURE=0.35, TEAM_POST_GRAVITY=0.20, D_POA=-0.50),
        ...
        "Cut": _w(TEAM_CUTTING=0.30),
        "PnP": _w(SC_POP_THREAT=0.40, TEAM_POST_GRAVITY=0.25, TEAM_SPACING=0.30),
    },
    "Horns_Elbow": {
        ...
        "ISO": _w(BH_PULLUP_THREAT=0.45, BH_DRIVE_PRESSURE=0.35, TEAM_SPACING=0.20, SC_SCREEN_QUALITY=0.20, D_POA=-0.55),
        ...
        "PnP": _w(SC_POP_THREAT=0.60, BH_PNR=0.55, SC_SCREEN_QUALITY=0.40, TEAM_SPACING=0.25, D_POA=-0.45),
    },
    "Transition_Early": {
        "TransitionEarly": _w(TEAM_PACE=1.60, BH_DRIVE_PRESSURE=0.60, TEAM_SPACING=0.40, D_DREB=-0.50, D_POA=-0.30),
        "ISO": _w(BH_PULLUP_THREAT=0.30, BH_DRIVE_PRESSURE=0.20, TEAM_PACE=-0.40, D_POA=-0.40),
        "Drive": _w(BH_DRIVE_PRESSURE=0.70, TEAM_SPACING=0.30, D_POA=-0.30),
        "SpotUp": _w(TEAM_CATCH3_QUALITY=0.40, TEAM_SPACING=0.20),
        "PnR": _w(BH_PNR=-0.30),
        "PnP": _w(SC_POP_THREAT=0.20, BH_PNR=0.20, TEAM_PACE=-0.30),
    },
}
